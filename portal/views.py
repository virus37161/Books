...
class ListOfMyBooks(ListView):
    model = Book
    template_name = 'list_of_my_books.html'
    context_object_name = 'books'
...
class BooksWithFilter(ListView):
    model = Book
    template_name = 'books_with_filter.html'
    context_object_name = 'books'
...
class AuthorWithFilter(ListView):
    model = Author
    template_name = 'author_with_filter.html'
    context_object_name = 'authors'
...
class ListOfLikeBook(LoginRequiredMixin, ListView):
    model = Book
    template_name = 'list_of_like_book.html'
...
class ListOfLikeAuthor(LoginRequiredMixin, ListView):
    model = Author
    template_name = 'list_of_like_authors.html'
